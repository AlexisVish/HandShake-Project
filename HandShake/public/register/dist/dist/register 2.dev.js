...
function () {
  ...
  RegisterForm.prototype.createForm = function () {
    ...
    form.id = "form";
    form.innerHTML = "\n            <div id=\"form__field\">\n                <label for=\"name\" class=\"form__label\">Name:</label>\n                <input type=\"text\" id=\"name\" name=\"name\" class=\"form__input\" placeholder=\"Enter your name\" required>\n            </div>\n            <div id=\"form__field\">\n                <label for=\"email\" class=\"form__label\">Email:</label>\n                <input type=\"email\" id=\"email\" name=\"email\" class=\"form__input\" placeholder=\"Enter your email\" required>\n            </div>\n            <div id=\"form__field\">\n                <label for=\"phone\" class=\"form__label\">Phone:</label>\n                <input type=\"tel\" id=\"phone\" name=\"phone\" class=\"form__input\" placeholder=\"Enter your phone number\" required>\n            </div>\n            <div id=\"form__field\">\n                <label for=\"password\" class=\"form__label\">Password:</label>\n                <input type=\"password\" id=\"password\" name=\"password\" class=\"form__input\" placeholder=\"Enter your password\" required>\n            </div>\n            <div id=\"form__field\">\n                <button type=\"submit\" class=\"form__button\">Register</button>\n            </div>\n        ";
    return form;
  };
